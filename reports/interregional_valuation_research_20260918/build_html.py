...
<nav class="topnav" aria-label="Report shortcuts"><a href="#historicalExplorer">Historical evidence</a><a href="#eventExplorer">Scarcity events</a><a href="#valuationLab">Valuation workbench</a><a href="#fullResearch">Full research</a><a href="#chapter-23">Sources</a><button id="printReport">Print / save PDF</button></nav>
...
{figure_html('<div id="eventChart" class="plot" role="img" aria-label="Quarterly hours above 300 dollars and regional cap payout"></div>','Exhibit 2: More scarcity hours do not necessarily mean a more valuable cap','Source: archived project five-minute prices. Left axis: exceedance hours. Right axis: cap payout, AUD/MWh. The metrics refer to the selected quarter; the chart shows the full complete-quarter history.')}
<p class="exhibit-insight" id="eventIdentity" aria-live="polite"></p><p class="small-note">These are observed frequencies, not quarterly forecasts. Heat or cold, low renewable output, outages, storage depletion, binding constraints and rebidding can combine to trigger separation. See <a href="#chapter-7">chapter 7</a> for the trigger framework and <a href="#chapter-12">chapter 12</a> for occurrence, duration and severity models.</p></section>
...
{figure_html('<div id="impliedChart" class="plot" role="img" aria-label="Scarcity hours consistent with different conditional severity assumptions"></div>','Exhibit 3: The same cap price can support many frequency–severity combinations','Illustrative sensitivity, not an estimated market probability. Logarithmic severity axis. Changes in severity, risk loading or the scenario distribution alter the inference. The curve does not identify duration, coincidence, import availability or an SRA payout.')}
...
manifest={
    ...
    'notes':['No market data refreshed during presentation build.','Charts, scripts, styles and downloads are embedded. External references require internet access.','Historical data are descriptive, not a forecast or an independently reconciled exchange settlement series.']
}
